    ...
    try:
        ...
        def dev_channel_btn(message):
            ...
            bot.send_message(message.chat.id, "📢 قناة المطور الرسمية:",
                reply_markup=types.InlineKeyboardMarkup().add(
                    types.InlineKeyboardButton("📢 انضم للقناة", url="https://t.me/xc_dl")
                ))
        ...
        def dev_user_btn(message):
            ...
            bot.send_message(message.chat.id, "👨‍💻 مطور البوت:",
                reply_markup=types.InlineKeyboardMarkup().add(
                    types.InlineKeyboardButton("💬 تواصل مع المطور", url="https://t.me/RA_JaX")
                ))
        ...
        def buy_points(message):
            ...
            bot.send_message(message.chat.id,
                ...
                parse_mode="Markdown",
                reply_markup=types.InlineKeyboardMarkup().add(
                    types.InlineKeyboardButton("👨‍💻 تواصل مع المطور", url=settings.get('dev_user', 'https://t.me/RA_JaX'))
                )
            )
        ...
        def help_msg(message):
            ...
            bot.send_message(message.chat.id,
                ...
                parse_mode="Markdown",
                reply_markup=types.InlineKeyboardMarkup().add(
                    types.InlineKeyboardButton("📢 قناة المطور", url=settings.get('dev_channel', 'https://t.me/xc_dl'))
                )
            )
